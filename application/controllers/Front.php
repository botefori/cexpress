...
class Front extends CI_Controller {
	...
	public function follow_urpacket(){
	  $this->load->view('front-office/contactus/contactus');
    }
	
	public function price_ranges(){
	   $this->load->view('front-office/pricing/pricing');
	}
	
	public function our_services(){
	   $this->load->view('front-office/services/services');
	}
