    ...
    <div class="content container">
	    ...
	    <div class="row">
			<article class="service col-md-4 col-sm-6 col-xs-12">
			  <img class="icon" src="<?php echo base_url(); ?>images/ibaacra/icon-exoticpets.svg" alt="Icon">
			  <h3>Exotic Pets</h3>
			  <p>We offer specialized care for reptiles, rodents, birds, and other exotic pets.</p>
			</article>

			<article class="service col-md-4 col-sm-6 col-xs-12">
			  <img class="icon" src="<?php echo base_url(); ?>images/ibaacra/icon-grooming.svg" alt="Icon">
			  <h3>Grooming</h3>
			  <p>Our therapeutic grooming treatments help battle fleas, allergic dermatitis, and other challenging skin conditions.</p>
			</article>

			<article class="service col-md-4 col-sm-6 col-xs-12">
			  <img class="icon" src="<?php echo base_url(); ?>images/ibaacra/icon-health.svg" alt="Icon">
			  <h3>GeneralHealth</h3>
			  <p>Wellness and senior exams, ultrasound, x-ray, and dental cleanings are just a few of our general health services.</p>
			</article>

			<article class="service col-md-4 col-sm-6 col-xs-12">
			  <img class="icon" src="<?php echo base_url(); ?>images/ibaacra/icon-nutrition.svg" alt="Icon">
			  <h3>Nutrition</h3>
			...
			<article class="service col-md-4 col-sm-6 col-xs-12">
			  <img class="icon" src="<?php echo base_url(); ?>images/ibaacra/icon-pestcontrol.svg" alt="Icon">
			  <h3>Pest Control</h3>
			...
			<article class="service col-md-4 col-sm-6 col-xs-12">
              <img class="icon" src="<?php echo base_url(); ?>images/ibaacra/icon-vaccinations.svg" alt="Icon">
              <h3>Vaccinations</h3>
	   ...
	   <h2 id="ourstaff">Our Staff</h2>
	    <div class="row">
	      <div class="doctor col-lg-4">
		    <div class="row">
			  <div class="photo col-xs-6 col-xs-offset-3 col-sm-3 col-sm-offset-1 col-md-2 col-md-offset-2 col-lg-4 col-lg-offset-0">
			    <img class="img-circle" src="<?php echo base_url(); ?>images/ibaacra/doctor-winthrop.jpg" alt="Photo of Dr Sanders">
			  </div> <!-- photo -->
		  ...
		  <div class="doctor col-lg-4">
		    <div class="row">
			 <div class="photo  col-xs-6 col-xs-offset-3 col-sm-3 col-sm-offset-1 col-md-2 col-md-offset-2 col-lg-4 col-lg-offset-0">
			  <img class="img-circle" src="<?php echo base_url(); ?>images/ibaacra/doctor-chase.jpg"  alt="Photo of Dr Sanders">
			 </div> <!-- photo -->
			 <div class="info col-xs-8 col-xs-offset-2 col-sm-7 col-sm-offset-0 col-md-6  col-lg-8">
			   <h3>Dr. Chase</h3>
		  ...
		  <div class="doctor col-lg-4">
		    <div class="row">
			 <div class="photo  col-xs-6 col-xs-offset-3 col-sm-3 col-sm-offset-1 col-md-2 col-md-offset-2 col-lg-4 col-lg-offset-0">
			   <img class="img-circle" src="<?php echo base_url(); ?>images/ibaacra/doctor-sanders.jpg" alt="Photo of Dr Sanders">
			 </div> <!-- photo -->
			 <div class="info col-xs-8 col-xs-offset-2 col-sm-7 col-sm-offset-0 col-md-6  col-lg-8">
			  <h3>Dr Sanders</h3>
